  ...
  return (
    <div className="page-bg" style={{ minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '40px 24px 80px', position: 'relative', zIndex: 1 }}>
        <Link href={`/meetups/${id}`} style={{ fontSize: 14, color: 'rgba(255,255,255,.4)', textDecoration: 'none', display: 'inline-block', marginBottom: 20 }}>
          ← Back to meetup
        </Link>
        <h1 style={{ fontSize: 28, fontWeight: 900, letterSpacing: -1, marginBottom: 4 }}>Edit Meetup</h1>
